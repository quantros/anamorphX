"""
AST Interpreter Package.

This package provides a complete AST interpreter for the Anamorph language,
including support for neural constructs, signal processing, and advanced
execution features.
"""
